...
DEF = ROOT / "PowerBI" / "EnterpriseFPA.SemanticModel" / "definition"
DATABASE = "FinancePlanningBI"
...
FACTS = {"FactGL", "FactFinancials", "FactARInvoice", "FactAPBill", "FactCashBalance"}
...
CALC_ITEM_ORDER = {
    "Plan Version": ["Actual", "Budget", "Forecast", "Var vs Budget", "Var % vs Budget",
                     "Var vs Forecast", "Var % vs Forecast"],
    "Period View": ["Selected period", "Year to date", "Prior year", "Prior year to date"],
}
NO_FORMAT_OK = {"Reporting Currency", "Report Context", "Selected Financial Year", "DQ Metric Unit",
                "Opex Variance Colour", "Revenue Variance Colour", "Variance Bar Colour",
                "Outlook Variance Colour"}
...
def main():
    ...
    for tbl in ("DimEntity", "DimDepartment", "FactARInvoice", "FactAPBill", "FactCashBalance", "SecurityUserAccess"):
